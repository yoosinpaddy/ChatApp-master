package com.Trichain.chatapp.adapters;
...
import com.Trichain.chatapp.holders.MessageHolder;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageHolder>
{
    ...
    public void onBindViewHolder(final MessageHolder holder, int position)
    {
        ...
        {
            holder.setRightMessage(c.getFrom(), c.getMessage(), c.getTimestamp(), c.getType(),holder);
        }
        else
        {
            holder.setLeftMessage(c.getFrom(), c.getMessage(), c.getTimestamp(), c.getType(),holder);
        }
    }
